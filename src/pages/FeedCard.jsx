...
<Form.Text className="text-muted">
    ...
    <Card style={{ width: '28rem', margin: '1rem'}}>
      ...
      <Card.Body>
        ...
        <img src={`/../uploads/${post.author.image}`} className="profile-pic" />
        <Card.Title style={{padding: "12px"}} className="author">{post.author.name} {post.author.lastName} </Card.Title>
        </div>
